...
export function PartnerAnalytics() {
  ...
  const loadAnalytics = async () => {
    try {
      ...
      const completionRate = totalRespondents ? (completedCount / totalRespondents) * 100 : 0;
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex items-center gap-4 mb-8">
          ...
          <div>
            ...
            <p className="text-white/80">Track your coaching network performance</p>
          </div>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          >
            <h2 className="text-2xl font-bold text-white mb-6">Coach Performance</h2>
          ...
          <motion.div
            ...
            className="glass-effect rounded-3xl p-8"
          >
            <h2 className="text-2xl font-bold text-white mb-6">Assessment Trends</h2>
            <div className="text-white/60 text-center py-8">
