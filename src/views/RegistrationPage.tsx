...
import { AlertCircle, Brain, Shield } from "lucide-react";
...
export function RegistrationPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const { isValid, coachId } = await verifyAssessmentCode(
        formData.assessmentCode.trim()
      );
      if (!isValid || !coachId) {
      ...
      <div className="max-w-3xl mx-auto">
        ...
        >
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div>
              <label htmlFor="assessmentCode" className="block text-white mb-2">
                Assessment Code
              </label>
              <input
                type="text"
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-start gap-3">
                ...
                >
                  ...
                  and agree to be bound by its conditions.
                </label>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                >
                  ...
                  and understand the assessment's scope and limitations.
                </label>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <label htmlFor="gdprAccepted" className="text-white/80 text-sm">
                  By proceeding, I acknowledge that the Personality Breakthrough
                  Profile is a coaching and personal development tool intended
                  solely for informational and educational purposes. It is not a
                  psychological, medical, or diagnostic test, and its results do
                  not diagnose, treat, or predict any psychological, medical, or
                  health conditions. I understand that the results are based on
                  my responses and the profile's methodology and may not
                  guarantee accuracy, completeness, or applicability. I agree to
                  use the results at my sole discretion and assume full
                  responsibility for any decisions made. I hereby release,
                  indemnify, and hold harmless the creators, affiliates,
                  independent practitioners, and any associated parties of the
                  Personality Breakthrough Profile from all claims, liabilities,
                  damages, or losses, including direct, indirect, or
                  consequential damages, arising out of or related to my use of
                  this profile and its results.
                </label>
              </div>
